    ...
    renderRateControl(rate) {
        ...
        return (
            <TouchableOpacity onPress={() => { this.setState({rate: rate}) }}>
                {/*style = {style.controlOption}*/}
                <Text style={{alignSelf: 'center',fontSize: 11,color: "white",paddingLeft: 0,paddingRight: 2,lineHeight: 12,backgroundColor:'transparent',fontWeight: isSelected ? "bold" : "normal"}}>
                    快进:{rate}x
                </Text>
            </TouchableOpacity>
        )
    ...
    renderSocialHubControl (id) {
        ...
        return (
            <TouchableOpacity onPress = {Orientation.lockToLandscape}>
                <Image style = {{width:26,height:26,marginRight:5,right:0,borderRadius:13}} source = {images[id]}/>
            </TouchableOpacity>
        );
    }
    renderBackbuttonControl () {
        ...
        return (
            <TouchableOpacity onPress = {this.backAction.bind(this)}>
                <View style = {{width:35,height:35,marginLeft:5,right:0,alignItems:'center',justifyContent:'center'}}>
                    <Image style = {{width:9,height:15,resizeMode:Image.resizeMode.contain}} source = {require('../../Images/VideoPlayer/live_back.png')}/>
                </View>
            </TouchableOpacity>
        );
    }
    ...
    renderTopRightControl (id) {
        ...
        return (
            <TouchableOpacity onPress = {this.showClickedTopRightId.bind(this,id)}>
                <View style = {{width:35,height:35,marginLeft:5,right:0,alignItems:'center',justifyContent:'center'}}>
                    <Image style = {{width:20,height:20,resizeMode:Image.resizeMode.contain}} source = {images[id]}/>
                </View>
            </TouchableOpacity>
        );
    }
    ...
    renderCustomSkin() {
        ...
        return (
            <View style={styles.container}>
                <TabNavigator  tabBarStyle={{ height: 0, overflow: 'hidden' }}/>
                ...
                {/* 上遮罩View */}
                <View style = {{position:'absolute',backgroundColor:'black',top:20,height:40,left:0,right:0}}>
                    <View style = {{flex:1,justifyContent:'center',alignItems:'center',flexDirection:'row'}}>
                        <View style = {{backgroundColor:'transparent',height:40,flex:0.25}}>
                            {this.renderBackbuttonControl()}
                        </View>
                        <View style = {{backgroundColor:'transparent',flex:0.75,height:40,right:0,flexDirection:'row',justifyContent:'flex-end'}}>
                ...
                {/* 社交四个按钮 */}
                <View style = {{backgroundColor:'transparent',position:'absolute',bottom:10,right:4,height:40,width:ScreenWidth/2}}>
